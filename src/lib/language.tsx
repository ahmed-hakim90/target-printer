...
const ar: Record<string, string> = {
  Home: "الرئيسية",
  Products: "المنتجات",
  "Key specifications": "أهم المواصفات",
  "Print Speed": "سرعة الطباعة",
  Duplex: "طباعة مزدوجة",
  Connectivity: "الاتصال",
  Memory: "الذاكرة",
  "Working Width": "عرض التشغيل",
  "Working Speed": "سرعة التشغيل",
  Operation: "التشغيل",
  "Print Width": "عرض الطباعة",
  "Ink Colors": "ألوان الحبر",
  Printheads: "رؤوس الطباعة",
  Solutions: "الحلول",
  ...
  "Download printer drivers": "تحميل تعريفات الطابعة",
