...
export function ComingSoonSection() {
  ...
  return (
    <section
      id="coming-soon"
      className="relative scroll-mt-20 overflow-hidden bg-primary/95 py-16 text-white md:py-24"
    >
          ...
          {comingSoonProducts.map((product) => {
            ...
            return (
              <StaggerItem key={product.id} className="h-full">
                <article className="group h-full rounded-2xl border border-white/15 bg-white/[.06] p-6 backdrop-blur transition duration-300 hover:-translate-y-1 hover:border-blue-300/60 hover:bg-white/[.1] focus-within:border-blue-300">
